...
if __name__ == "__main__":
    # ---------------------------------------------------------------------------------- #
   # Teste: obter lista com os produtos mais populares
    ...
    print("Produtos mais populares:",
          recommendation_agent.get_popular_recommendations())
    print("Cafés mais populares:", recommendation_agent.get_popular_recommendations(
        product_categories="Coffee"))
    print("Itens de padaria mais populares:",
          recommendation_agent.get_popular_recommendations(product_categories="Bakery"))
    print("Recomendações Apriori ao adicionar Latte ao carrinho:",
